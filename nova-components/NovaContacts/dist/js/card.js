...
Nova.booting(function (Vue, router, store) {
  Vue.component('nova-contacts', __webpack_require__(2));
});
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "flex flex-col items-center justify-center nova-contacts contacts-card"
    },
    [
      _c("div", { staticClass: "px-3 py-3" }, [
        _c("h1", [_vm._v("Информация по проекту")]),
        _vm._v("\n        Тестовая площадка: "),
        _c("a", { attrs: { href: _vm.flagstudioInfo.testapp } }, [
          _vm._v(_vm._s(_vm.flagstudioInfo.testapp))
        ]),
        _c("br"),
        _vm._v("\n        Логин: " + _vm._s(_vm.flagstudioInfo.login)),
        _c("br"),
        _vm._v("\n        Пароль: " + _vm._s(_vm.flagstudioInfo.password)),
        _c("br"),
        _vm._v("\n        Ваш менеджер: " + _vm._s(_vm.flagstudioInfo.manager)),
        _c("br"),
        _vm._v("\n        E-mail: " + _vm._s(_vm.flagstudioInfo.email)),
        _c("br"),
        _vm._v("\n        Телефон: " + _vm._s(_vm.flagstudioInfo.phone)),
        _c("br")
      ])
    ]
  )
