...
Nova.booting(function (Vue, router, store) {
  Vue.component('nova-instructions', __webpack_require__(2));
});
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "flex flex-col items-center justify-center nova-instructions instructions-card"
    },
    [
      _c("div", { staticClass: "px-3 py-3" }, [
        _c("h1", [_vm._v("Инструкции")]),
        _vm._v(" "),
        _c(
          "ul",
          _vm._l(_vm.instructions, function(instruction) {
            return _c("li", [
              _c(
                "a",
                {
                  attrs: { href: instruction.link ? instruction.link : false }
                },
